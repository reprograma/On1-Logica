...
let multiplicacaocao = soma + 2;

// Mostre o valor das variáveis 'soma' e 'multiplicacao' usando três formas diferentes 
console.log(soma);
console.log(multiplicacaocao);
document.write(soma);
document.write(multiplicacaocao);
alert(soma);
alert(multiplicacaocao);
...
let queroSerDesenvolvedora = true;
...
let sanduba = ['pao', 'ovo', 'queijo', 'alface', 'tomate', 'presunto', 'manteiga'];
