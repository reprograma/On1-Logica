...
'2' === 2; // false //because the type is different

// 0 é igual a -0
0 == -0;    //true //but using Object.is(0,-0) results in false

// 'banana' é maior que 'Banana'
// Cada letra tem um valor ascii/binário, que é analisado.
'banana' > 'Banana';    // true, porque o valor de b é maior do que o de B
